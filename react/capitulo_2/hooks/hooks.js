...
let numerico = parseInt(numero.textContent)
sumar.addEventListener("click",()=> numero.textContent = numerico += 1)
restar.addEventListener("click",()=> numero.textContent = numerico -= 1)