...
const otro1 = document.querySelector(".otro1")
const otro2 = document.querySelector(".otro2")
class contadorObjeto{
    constructor(aumentar){
        this.aumentar = aumentar
    }

    contar(modificar){
        setInterval(() => {
            modificar.textContent = this.aumentar++
        }, 1000);
    }
}

const mostrar = new contadorObjeto(0);
mostrar.contar(contador)
mostrar.contar(otro1)
mostrar.contar(otro2)