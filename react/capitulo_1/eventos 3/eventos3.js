...
const nativos = document.getElementById("nativos");
const error = document.getElementById("error");

react.addEventListener("click",()=>{
    error.textContent = "esto no esta hecho en react asi que no mostrara nada :v"
    error.classList.add("mostrarErr")
    setTimeout(() => {
        error.textContent = ""
        error.classList.remove("mostrarErr") 
    }, 3000);
})

nativos.addEventListener("click",(e)=>{
    console.log(e);
...
const saludarHumano = document.getElementById("saludarHumano").addEventListener("click",()=>{
    console.log("hola humano")
})