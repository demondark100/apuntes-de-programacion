...
const contenedor_c = document.getElementById("contenedor_c");
const texto_C = document.getElementById("texto_C");
const mostrar_name = document.getElementById("mostrar_name");
let name = ""



contenedor_c.addEventListener("click",(e)=>{
    texto_C.focus()
})

texto_C.addEventListener("keydown",e=>{
    if(e.key === "Enter"){
        name = texto_C.textContent;
        mostrar_name.textContent = name
    }
